...
-- Local touchpad device on this Acer Nitro.

-- Keep this here so the default JaKooLit laptop config can update without

-- putting the old ASUS touchpad name back in charge.

local Touchpad_Device = "pixa3848:00-093a:3848-touchpad"
